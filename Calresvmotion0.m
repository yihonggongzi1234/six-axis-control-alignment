function [Para_opt,Base_pos,Sixgle_pos,Upper_pos] = Calresvmotion0(R,r,D,d,Center_pos,Center_pos0,Base_H,Angle_Pitch,Angle_Yaw,Angle_rotate,G_bar,G_c)
%   三角盘的反解工程
%   此处显示详细说明
%   对结构简图进行复现
...
%% 位置和长度解算
    [Para_opt,Base_pos,Sixgle_pos,Upper_pos] = CalresLength(R,r,D,d,Center_pos,Center_pos0,Base_H,Angle_Pitch,Angle_Yaw,Angle_rotate);    
%%  计算缸的推力
%  Bar_Arrow是杆件的行程信息
